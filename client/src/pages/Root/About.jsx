import pic1 from "../../assets/about.jpg";
import pic2 from "../../assets/about-bottom.jpg";

const About = () => {
  return (
    <div className="px-4 md:px-12 lg:px-40 xl:px-60 2xl:px-80 py-12 md:text-lg">
      ...
      <ul className="list-disc ml-8 md:ml-20 mt  mb-20 space-y-4">
        <li>
      ...
      <div className="flex items-center justify-center relative">
        <h1 className="absolute text-white font-bold text-5xl leading-tight md:text-7xl max-w-[300px] md:max-w-[700px] bottom-5 left-5">
          Thank you for visiting Restate.
        </h1>
